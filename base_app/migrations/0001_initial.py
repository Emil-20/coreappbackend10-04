# Generated by Django 4.0 on 2022-04-09 17:18
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('total_fee', models.IntegerField(blank=True, default=0, null=True)),
                ('amount', models.IntegerField(blank=True, default=0, null=True)),
                ('pay_date', models.DateField(blank=True, default=0, null=True)),
                ('balence', models.IntegerField(blank=True, default=0, null=True)),
                ('total_pay', models.IntegerField(blank=True, default=0, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('confirm_salary', models.CharField(default='', max_length=255)),
                ...
                ('trainer_level', models.CharField(blank=True, default='', max_length=100, null=True)),
